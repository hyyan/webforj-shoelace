...
/**
 * Emitted when a tab is shown in a TabGroup component.
 *
...
public class TabShowEvent<T extends ElementComposite> extends ComponentEvent<T> {

  public TabShowEvent(T component, Map<String, Object> payload) {
    super(component, payload);
  }

  /**
   * Gets the name of the tab panel that was shown.
   *
